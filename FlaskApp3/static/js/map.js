...
function buildMap(year) {
    ...
    var divorceUrl = `/metadata/year/${year}`;
    d3.json(divorceUrl, function (data) {
        console.log('state data', data);
        var divorce_rates = data.divorce_rates;
        ...
        d3.json(mapUrl, function (json) {
            ...
            for (var i = 0; i < data.states.length; i++) {
                ...
                // Grab data value
                var dataValue = data.divorce_rates[i];
                ...
                for (var j = 0; j < json.features.length; j++) {
                    ...
                    if (dataState == jsonState) {
                        ...
                        json.features[j].properties.divorce_rates = dataValue;
            ...
            svg.selectAll("path")
                ...
                .style("fill", function (d) {
                    var value = d.properties.divorce_rates;
                ...
                .on("mouseover", function (d) {
                    ...
                    toolTip.html(`<strong>${d.properties.name}</strong>
                                <p>${d.properties.divorce_rates}</p>`)
